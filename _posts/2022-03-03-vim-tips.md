...
* 代码更新后自动更新ctags内容：在`~/.vim_runtime/my_configs.vim`文件中添加一句`autocmd BufWritePost *.cc,*.c,*.h silent! !ctags . &`
...
" Auto generate tags file on file write of *.cc, *.c and *.h files
autocmd BufWritePost *.cc,*.c,*.h silent! !ctags . &
