...
* 使用`pip install yapf`安装[yapf](https://github.com/google/yapf)
...
#### 3.4.2 vim-yapf-format相关设置
> 完成如下设置可在VIM保存文件或使用`,y`快捷键时对代码进行格式化操作。
...
autocmd FileType python nnoremap <Leader>y :YapfFullFormat<Cr><C-o>
autocmd BufWritePre *.py YapfFullFormat
```
